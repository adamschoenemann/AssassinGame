...
public class NativeCamera extends Activity implements CvCameraViewListener {
    ...
    public Mat onCameraFrame(Mat inputFrame) {
        switch (NativeCamera.viewMode) {
            case NativeCamera.VIEW_MODE_GRAY:
            {
                Imgproc.cvtColor(inputFrame, mRgba, Imgproc.COLOR_GRAY2RGBA, 4);
            } break;
            case NativeCamera.VIEW_MODE_RGBA:
            {
...
//                Core.putText(mRgba, "OpenCV+Android", new Point(10, inputFrame.rows() - 10), 3, 1, new Scalar(255, 0, 0, 255), 2);
            ...
            case NativeCamera.VIEW_MODE_CANNY:
            {
